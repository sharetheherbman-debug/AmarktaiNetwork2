...
export const MODEL_REGISTRY: readonly ModelEntry[] = [
...

  {
    ...
    fallback_priority: 2,
    validator_eligible: true,
    specialist_domains: ['reasoning', 'math', 'science', 'coding', 'analysis'],
    category: 'text',
  },
  {
    provider: 'openai',
    ...
    fallback_priority: 3,
    validator_eligible: true,
    specialist_domains: ['reasoning', 'math', 'coding'],
    category: 'text',
  },
  {
    provider: 'openai',
  ...
  },
  {
    ...
    family: 'GPT-4',
    primary_role: 'reasoning',
    secondary_roles: ['chat', 'coding', 'creative', 'vision', 'multilingual'],
    supports_chat: true,
    supports_reasoning: true,
    supports_code: true,
    supports_tool_use: true,
    ...
    fallback_priority: 3,
    validator_eligible: true,
    specialist_domains: ['general', 'analysis', 'finance', 'coding'],
    category: 'multimodal',
  },
  {
    provider: 'openai',
  ...
  },
  {
    ...
    family: 'GPT-4',
    primary_role: 'coding',
    secondary_roles: ['chat', 'reasoning', 'agent_planning'],
    supports_chat: true,
    supports_reasoning: true,
    supports_code: true,
    supports_tool_use: true,
    ...
    fallback_priority: 2,
    validator_eligible: true,
    specialist_domains: ['coding', 'instruction_following', 'general'],
    category: 'text',
  },
  {
    provider: 'openai',
  ...
  },
  {
    ...
    fallback_priority: 3,
    validator_eligible: false,
    specialist_domains: ['general', 'coding', 'fast_inference'],
    category: 'text',
  },
  {
    provider: 'groq',
...

  {
    ...
    fallback_priority: 2,
    validator_eligible: true,
    specialist_domains: ['general', 'coding', 'reasoning', 'fast_inference'],
    category: 'multimodal',
  },
  {
    provider: 'gemini',
  ...
  },
  {
    ...
    fallback_priority: 1,
    validator_eligible: true,
    specialist_domains: ['reasoning', 'analysis', 'coding', 'long_context'],
    category: 'multimodal',
  },
  ...
  },
  {
    ...
    provider_tier: 'backbone',
    model_id: 'microsoft/phi-3-mini-4k-instruct',
    model_name: 'Phi-3 Mini 4K Instruct (HuggingFace)',
    family: 'Phi-3',
    primary_role: 'chat',
    secondary_roles: ['coding'],
    supports_chat: true,
  ...
  },
  {
    ...
    provider_tier: 'backbone',
    model_id: 'mistralai/Mistral-7B-Instruct-v0.3',
    model_name: 'Mistral 7B Instruct v0.3 (HuggingFace)',
    family: 'Mistral',
    primary_role: 'chat',
    secondary_roles: ['coding', 'multilingual'],
    supports_chat: true,
  ...
  },
  {
    ...
    fallback_priority: 2,
    validator_eligible: false,
    specialist_domains: ['text_to_speech', 'voice'],
    category: 'voice',
  },
  {
    provider: 'huggingface',
  ...
  },
  {
    ...
    fallback_priority: 2,
    validator_eligible: false,
    specialist_domains: ['embeddings', 'search', 'semantic_similarity'],
    category: 'text',
  },
  ...
  },
  {
    ...
    fallback_priority: 2,
    validator_eligible: true,
    specialist_domains: ['general', 'coding', 'chat'],
    category: 'text',
  },
  {
    provider: 'together',
  ...
  },
  {
    ...
    provider_tier: 'backbone',
    model_id: 'mistralai/Mixtral-8x22B-Instruct-v0.1',
    model_name: 'Mixtral 8x22B Instruct v0.1 (Together)',
    family: 'Mixtral',
    primary_role: 'chat',
    secondary_roles: ['coding', 'reasoning', 'multilingual'],
    supports_chat: true,
    ...
    fallback_priority: 3,
    validator_eligible: false,
    specialist_domains: ['general', 'coding', 'multilingual'],
    category: 'text',
  },
  {
    provider: 'together',
  ...
  },
  {
    ...
    provider_tier: 'multimodal',
    model_id: 'stabilityai/stable-diffusion-xl-base-1.0',
    model_name: 'Stable Diffusion XL Base 1.0 (Together)',
    family: 'Stable-Diffusion',
    primary_role: 'image_generation',
    secondary_roles: ['creative'],
    supports_chat: false,
...

  {
    ...
    family: 'Claude-3.5',
    primary_role: 'reasoning',
    secondary_roles: ['chat', 'coding', 'agent_planning', 'creative', 'vision'],
    supports_chat: true,
    supports_reasoning: true,
    supports_code: true,
    supports_tool_use: true,
    ...
    fallback_priority: 1,
    validator_eligible: true,
    specialist_domains: ['reasoning', 'coding', 'analysis', 'creative'],
    category: 'multimodal',
  },
  {
    provider: 'openrouter',
    provider_tier: 'backbone',
    model_id: 'anthropic/claude-3-haiku',
    model_name: 'Claude 3 Haiku (OpenRouter)',
    family: 'Claude-3',
    primary_role: 'chat',
    secondary_roles: ['coding', 'multilingual'],
    supports_chat: true,
...

  {
    ...
    fallback_priority: 2,
    validator_eligible: true,
    specialist_domains: ['reasoning', 'helpfulness', 'general'],
    category: 'text',
  },
  {
    provider: 'nvidia',
  ...
  },
  {
    ...
    fallback_priority: 1,
    validator_eligible: false,
    specialist_domains: ['reranking', 'search', 'retrieval'],
    category: 'text',
  },
  {
    provider: 'nvidia',
